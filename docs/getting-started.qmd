...
# Inspect
GlobalGrids.resolution(cell)   # resolution level
GlobalGrids.is_pentagon(cell)   # pentagon check (12 per resolution)
GlobalGrids.decode(cell)        # human-readable string
...
GlobalGrids.children(cell)     # finer child cells
GlobalGrids.siblings(cell)     # same-parent neighbor cells
```
